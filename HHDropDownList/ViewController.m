...
- (HHDropDownList *)dropDownList_3 {
    ...
    if (!_dropDownList_3) {
        ...
        [_dropDownList_3 setHighlightColor:[UIColor blueColor]];
...
//    //[self.dropDownList_1 pullBack];
//    
////    NSArray *array_1 = @[@"MacBook Air", @"MacBook Pro", @"newMacBook", @"Mac Pro", @"MacBook Air", @"MacBook Pro", ];
...
- (NSArray *)listDataForDropDownList:(HHDropDownList *)dropDownList {
    NSArray *array_1 = @[@"MacBook Air", @"MacBook Pro", @"newMacBook", @"Mac Pro", @"MacBook Air", @"MacBook Pro", ];
    NSArray *array_2 = @[@"iPhone SE", @"iPhone 6", @"iPhone 6S", @"iPhone 7"];
    NSArray *array_3 = @[@"你", @"我", @"他", @"她" ,@"它",@"ta"];

    
    if (dropDownList == self.dropDownList_1){
        
       [self.dropDownList_1._textLayer setString:@"销量"];
        
        return array_1;
    }
    else if (dropDownList == self.dropDownList_2){
        [self.dropDownList_2._textLayer setString:@"排名"];
        return array_2;
    }
    else{
        [self.dropDownList_3._textLayer setString:@"颜值"];
        return array_3;
    }
//    return _dataArray;
}
