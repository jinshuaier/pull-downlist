...
//    UITapGestureRecognizer *tapGesture = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(tapped:)];
    ...
    __textLayer = [self createTextLayerWithText:@"iMac" color:[UIColor blackColor] withPosition:position];
...
- (void)reloadListData {
    ...
    [self animateTextLayer:self._textLayer isShow:YES completion:^{
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [self._textLayer setString:itemName];
